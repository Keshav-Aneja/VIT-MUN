  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="w-full h-[63%] relative flex flex-col gap-8 justify-center items-center">
        ...
        />
        <div className="btn-menu w-fit  flex gap-2  font-cereal text-xs">
          <button className="px-6 py-2 rounded-l-full outline-none border-0 shadow-[0px_0px_15px_rgba(0,0,0,0.2)] cursor-pointer">
      ...
      <div className="w-full h-[30%] relative">
        ...
        <Image
          ...
          width={1000}
          height={1000}
          className="w-52 absolute bottom-0 right-0"
        />
        <Image
