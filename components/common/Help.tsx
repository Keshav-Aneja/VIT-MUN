        ...
        <div className="w-[80%] mx-auto container flex  py-24 md:flex-row flex-col items-center">
          <section className="w-full md:w-[60%]">
            <div className="wrapper md:w-[70%] text-sm md:text-lg">
              <div className="text-3xl md:text-5xl font-cerealMed mb-6">
                Need Help?
              </div>
              <div className="mb-4 md:mb-8 leading-6 md:leading-relaxed">
              ...
              <div className="mb-4 md:mb-8 leading-relaxed">
          ...
          <section className="--qr-wrapper md:w-[40%]">
